...
var QueryDocumentKeysToValidate;
var init_validate2 = __esm({
  "../node_modules/graphql/validation/validate.mjs"() {
    ...
    QueryDocumentKeysToValidate = mapValue(
      QueryDocumentKeys,
...
function execute(args) {
  ...
  try {
    ...
    return buildResponse(result2, exeContext.collectedErrors.errors);
  } catch (error) {
    exeContext.collectedErrors.add(error, void 0);
    return buildResponse(null, exeContext.collectedErrors.errors);
  }
...
var collectSubfields2, CollectedErrors, defaultTypeResolver, defaultFieldResolver;
...
var init_module = __esm({
  "../node_modules/zen-observable-ts/module.js"() {
    ...
    if (hasSymbols()) {
      Object.defineProperty(Observable2, /* @__PURE__ */ Symbol("extensions"), {
        value: {
...
var require_utilities = __commonJS({
  "../node_modules/@apollo/client/utilities/utilities.cjs"(exports) {
    ...
    function getInclusionDirectives(directives) {
      ...
      if (directives && directives.length) {
        directives.forEach(function(directive) {
          ...
          globals.invariant(ifValue && (ifValue.kind === "Variable" || ifValue.kind === "BooleanValue"), 108, directiveName);
    ...
    var slot = (_a2 = global$1[deprecationsSlot]) !== null && _a2 !== void 0 ? _a2 : global$1[deprecationsSlot] = new optimism.Slot();
  ...
  "../node_modules/@apollo/client/cache/cache.cjs"(exports) {
    ...
    var InMemoryCache2 = (function(_super) {
      ...
      InMemoryCache3.prototype.broadcastWatch = function(c, options) {
        ...
        var diff2 = utilities.muteDeprecations("canonizeResults", function() {
          return _this.diff(c);
        });
        if (options) {
  ...
  "../node_modules/@apollo/client/core/core.cjs"(exports) {
    ...
    var ObservableQuery = (function(_super) {
      ...
      ObservableQuery2.prototype.setVariables = function(variables) {
        ...
        if (equal2.equal(this.variables, variables)) {
          return this.observers.size ? utilities.muteDeprecations("observableQuery.result", function() {
            return _this.result();
          }) : Promise.resolve();
        }
      ...
      ObservableQuery2.prototype.reportError = function(error, variables) {
        var _this = this;
        var errorResult = tslib.__assign(tslib.__assign({}, utilities.muteDeprecations("getLastResult", function() {
    ...
    var QueryInfo = (function() {
      ...
      QueryInfo2.prototype.setDiff = function(diff2) {
        ...
        if (diff2 && !diff2.complete && utilities.muteDeprecations("getLastError", function() {
          var _a3;
        ...
        if (options.fetchPolicy === "no-cache") {
          ...
          if (shouldWriteResult(result2, options.errorPolicy)) {
            this.cache.performTransaction(function(cache2) {
              ...
              var diff3 = utilities.muteDeprecations("canonizeResults", function() {
      ...
      QueryManager2.prototype.refetchQueries = function(_a2) {
        ...
        if (includedQueriesById.size) {
          includedQueriesById.forEach(function(_a3, queryId) {
            ...
            if (onQueryUpdated) {
              if (!diff2) {
                diff2 = utilities.muteDeprecations("canonizeResults", function() {
    ...
    var ApolloClient2 = (function() {
      ...
      ApolloClient3.prototype.watchFragment = function(options) {
        var _a2;
        return this.cache.watchFragment(tslib.__assign(tslib.__assign({}, options), (_a2 = {}, _a2[/* @__PURE__ */ Symbol.for("apollo.dataMasking")] = this.queryManager.dataMasking, _a2)));
      };
